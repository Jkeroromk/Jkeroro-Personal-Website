...
const Tabs = () => {
  ...
  return (
    <div className="mt-2 flex flex-col justify-center items-center w-full px-4 z-10">
      {isAdmin && (
        <div className="flex flex-col items-center bg-white bg-opacity-40 border-2 border-black py-6 rounded-3xl mt-10 w-full sm:w-[550px]">
          ...
          <input
            ...
            className="mt-4 p-2 border-2 border-black rounded-md"
          />
          <input
            type="text"
          ...
          <button
            ...
            className="mt-4 py-2 px-4 bg-blue-500 text-white rounded-md disabled:bg-gray-400"
          >
      ...
      <div className="flex flex-col items-center w-full">
        <a
          ...
          className="flex flex-col items-center bg-white bg-opacity-40 border-2 border-black py-4 rounded-3xl mt-10 w-full sm:w-[550px] transition-transform duration-300 hover:scale-105 hover:shadow-[0_0_20px_white] heartbeat"
        >
      ...
      <div className="flex gap-x-3">
        <ArrowLeft className="text-white mt-3" onClick={resetAutoplay} />
        <h2 className="flex justify-center text-white font-extrabold text-xl mt-2">
          Swap me
        </h2>
        <ArrowRight className="text-white mt-3" onClick={resetAutoplay} />
      </div>
      ...
      >
        <CarouselContent>
          {fetchError ? (
            <p className="text-red-500 font-bold text-center">{fetchError}</p>
            ...
            carouselItems.map((item) => (
              <CarouselItem key={item.id} className="flex justify-center">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center bg-white bg-opacity-40 border-2 border-black hover:border-white transition-color duration-300 py-6 px-8 rounded-3xl w-full sm:w-[550px]"
                >
                  <h1 className="text-xl font-extrabold text-black hover:text-white transition-colors duration-300">
                    {item.title}
                  </h1>
      ...
      <div className="flex flex-col items-center w-full">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex flex-col items-center bg-white bg-opacity-40 border-2 border-black py-6 rounded-3xl mt-16 w-full sm:w-[550px] transition-transform duration-300 hover:scale-105 hover:shadow-[0_0_20px_white] heartbeat"
        >
          <h1 className="text-xl font-extrabold text-black hover:text-white transition-colors duration-300">
            Rednote
          </h1>
      ...
      <div className="flex flex-col items-center w-full">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex flex-col items-center bg-white bg-opacity-40 border-2 border-black py-6 rounded-3xl mt-10 w-full sm:w-[550px] transition-transform duration-300 hover:scale-105 hover:shadow-[0_0_20px_white] heartbeat"
        >
          <h1 className="text-xl font-extrabold text-black hover:text-white transition-colors duration-300">
            Discord
          </h1>

...
const cleanupDuplicateCountries = async () => {
  try {
    ...
    if (!snapshot.exists()) {
      console.log("No countries data to clean.");
      return;
    }
    ...
    console.log("Country data merged successfully!");
    ...
    for (const country in data) {
      ...
      if (normalizedCountry && country !== normalizedCountry) {
        ...
        console.log(`Removed duplicate entry: ${country}`);
      }
    }

    console.log("Country duplicates fully cleaned up!");
  } catch (error) {
